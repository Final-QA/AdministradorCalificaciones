...
namespace AdministradorCalificaciones
{
    public partial class frmListarCalificaciones : Form
    {
        ...
        private void frmListarCalificaciones_Load(object sender, EventArgs e)
        {
            ...
            string[] lineas1 = File.ReadAllLines("estudianteslista.txt");
            ...
            for (int i = 0; i < lineas1.Length; i++)
            {
                ...
                indice[i] = Math.Round(puntos_honor / creditos, 2);
                ...
                if (indice[i].ToString() == "NaN")
                {
                    string indices = indice[i].ToString();
                    indices = "";
                    print[i] = ID[i] + ":" + Nombre[i] + ":" + Carrera[i] + ":" + indices + ":" + honor[i];
                }
